  ...
  <tr>
    ...
    <td class="controls">
      <a class="edit btn btn-sm btn-primary"
         data-action="edit"
         data-id="<@= user.id @>"
         href="/friends/<@= user.id @>/send>">
        Send message
      </a>
      <a class="delete btn btn-sm btn-danger"
         data-action="delete"
         data-id="<@= user.id @>"
         href="/friends/<@= user.id @>/delete">
        Delete friends
      </a>
    </td>
  </tr>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title pull-left">
            Wellcome ${userFistName} ${userLastName}
          </h3>
          <a class="add btn btn-primary pull-right" href="/users">Find new friends</a>
